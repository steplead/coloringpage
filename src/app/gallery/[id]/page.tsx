...
export default function ColoringPageDetail({ params }: ColoringPageDetailProps) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <PageHeader
          title={<TranslatedText translationKey="gallery.detail.loading.title" fallback="Loading Coloring Page" />}
          description={<TranslatedText translationKey="gallery.detail.loading.description" fallback="Please wait while we retrieve the coloring page details..." />}
        />
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center py-16">
            ...
            <p className="mt-4 text-gray-600">
              <TranslatedText translationKey="common.loading" fallback="Loading..." />
            </p>
          </div>
        </div>
      </div>
  ...
  if (error || !image) {
    return (
      <div className="min-h-screen bg-gray-50">
        <PageHeader
          title={<TranslatedText translationKey="gallery.detail.error.title" fallback="Error Loading Coloring Page" />}
          description={<TranslatedText translationKey="gallery.detail.error.description" fallback="We couldn't find the coloring page you're looking for." />}
        />
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center py-16 bg-white rounded-lg shadow-md">
            ...
            <h2 className="text-xl font-bold text-gray-700 mb-2">
              <TranslatedText translationKey="gallery.detail.error.message" fallback="Coloring Page Not Found" />
            </h2>
            <p className="text-gray-600 mb-6">
              {error || <TranslatedText translationKey="gallery.detail.error.notFound" fallback="The coloring page you requested could not be found or is no longer available." />}
            </p>
            <div className="flex justify-center space-x-4">
              ...
              >
                ...
                <TranslatedText translationKey="gallery.backToGallery" fallback="Back to Gallery" />
              </Link>
              <Link 
                href="/create" 
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
                <TranslatedText translationKey="gallery.createAColoringPage" fallback="Create a Coloring Page" />
              </Link>
            </div>
          </div>
        </div>
          ...
          <ol className="flex items-center space-x-2">
            ...
            <li className="flex items-center">
              ...
              <Link href="/gallery" className="ml-2 text-gray-500 hover:text-gray-700">
                <TranslatedText translationKey="nav.gallery" fallback="Gallery" />
              </Link>
            </li>
            <li className="flex items-center">
              <svg className="h-5 w-5 text-gray-400 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <div className="mb-6">
                <h3 className="text-sm font-medium text-gray-700 mb-3">
                  <TranslatedText translationKey="gallery.detail.downloadOptions" fallback="Download Options" />
                </h3>
                <div className="flex flex-wrap gap-3">
                  ...
                  >
                    ...
                    <TranslatedText translationKey="gallery.detail.downloadButton" fallback="Download PNG" />
                  </button>
                  ...
                  >
                    ...
                    <TranslatedText translationKey="gallery.detail.printButton" fallback="Print This Page" />
                  </Link>
                </div>
              </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-blue-800">
                      <TranslatedText translationKey="gallery.detail.printingTips" fallback="Printing Tips" />
                    </h3>
                    <p className="text-sm text-blue-700 mt-1">
                      <TranslatedText translationKey="gallery.detail.printInstructions" fallback="For best results, click the Print button above and select 'Fit to Page' in your printer settings." />
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-4">
                <h3 className="text-sm font-medium text-gray-700 mb-2 flex items-center">
                  ...
                  <TranslatedText translationKey="gallery.detail.shareTitle" fallback="Share with friends and family" />
                </h3>
                {image && (
                  <SocialShareButtons 
          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">
                <TranslatedText translationKey="gallery.detail.aboutThisPage" fallback="About This Coloring Page" />
              </h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    <TranslatedText translationKey="gallery.detail.description" fallback="Description" />
                  </h3>
                ...
                {image.style && (
                  <div>
                    <h3 className="text-sm font-medium text-gray-500">
                      <TranslatedText translationKey="gallery.detail.style" fallback="Style" />
                    </h3>
                ...
                {image.category && (
                  <div>
                    <h3 className="text-sm font-medium text-gray-500">
                      <TranslatedText translationKey="gallery.detail.category" fallback="Category" />
                    </h3>
                    <p className="mt-1 text-sm text-gray-900">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    <TranslatedText translationKey="gallery.detail.created" fallback="Created On" />
                  </h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    <TranslatedText translationKey="gallery.detail.suitableFor" fallback="Best For" />
                  </h3>
                  <p className="mt-1 text-sm text-gray-900">
                    {image.style === 'simple' ? 
                      <TranslatedText translationKey="gallery.detail.suitableForYoungChildren" fallback="Young children (ages 2-5)" /> :
                     image.style === 'complex' ?
                      <TranslatedText translationKey="gallery.detail.suitableForOlderChildren" fallback="Older children and adults" /> :
                      <TranslatedText translationKey="gallery.detail.suitableForAllAges" fallback="All ages" />
                    }
                  </p>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                >
                  <TranslatedText translationKey="gallery.detail.createYourOwnButton" fallback="Create Your Own Coloring Page" />
                </Link>
                <p className="mt-2 text-sm text-gray-500 text-center">
                  <TranslatedText translationKey="gallery.detail.createYourOwnPrompt" fallback="It's free and takes just seconds!" />
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 mb-8">
              <h2 className="text-lg font-medium text-gray-900 mb-4 flex items-center">
                ...
                <TranslatedText translationKey="gallery.detail.coloringTips" fallback="Coloring Tips" />
              </h2>
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start">
                  ...
                  <TranslatedText translationKey="gallery.detail.tip1" fallback="Print on thicker paper for best results with markers or paints" />
                </li>
                <li className="flex items-start">
                  <svg className="h-4 w-4 text-green-500 mt-0.5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <TranslatedText translationKey="gallery.detail.tip2" fallback="Color lightest areas first, then work towards darker areas" />
                </li>
                <li className="flex items-start">
                  <svg className="h-4 w-4 text-green-500 mt-0.5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <TranslatedText translationKey="gallery.detail.tip3" fallback="Try using complementary colors for a vibrant effect" />
                </li>
              </ul>
            </div>
          </div>
        ...
        {relatedImages.length > 0 && (
          <div className="mt-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              <TranslatedText translationKey="gallery.detail.similarPages" fallback="You Might Also Like" />
            </h2>
            ...
            <div className="mt-8 text-center">
              ...
              >
                <TranslatedText translationKey="gallery.viewMore" fallback="Browse More Coloring Pages" />
