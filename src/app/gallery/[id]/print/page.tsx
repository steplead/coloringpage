      ...
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">
            <TranslatedText translationKey="print.loading" fallback="Loading coloring page..." lang={currentLang} />
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen flex items-center justify-center bg-white px-4">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-xl font-bold text-gray-900 mb-2">
            <TranslatedText translationKey="print.errorTitle" fallback="Failed to load coloring page" lang={currentLang} />
          </h1>
          <p className="text-gray-600 mb-6">
            {error || <TranslatedText translationKey="print.errorMessage" fallback="The coloring page you requested could not be found." lang={currentLang} />}
          </p>
          <div className="flex justify-center gap-4">
            ...
            >
              <TranslatedText translationKey="nav.gallery" fallback="Browse Gallery" lang={currentLang} />
            </Link>
            <Link
              href="/"
        ...
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-blue-100">
              <TranslatedText translationKey="print.readyToPrint" fallback="Ready to print. Use your browser's print function or click the button below." lang={currentLang} />
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <TranslatedText translationKey="print.backToView" fallback="Back to View" lang={currentLang} />
            </Link>
            <button
            ...
            >
              ...
              <TranslatedText translationKey="print.printButton" fallback="Print Page" lang={currentLang} />
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="print:hidden mt-10 bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
          <div className="bg-gray-100 py-3 px-6 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900 flex items-center">
              ...
              <TranslatedText translationKey="print.instructionsTitle" fallback="Printing Instructions" lang={currentLang} />
            </h2>
          </div>
          ...
          <div className="p-6">
            <div className="mb-6">
              <h3 className="text-sm font-semibold text-gray-800 mb-2">
                <TranslatedText translationKey="print.stepsTitle" fallback="Follow these steps for best results:" lang={currentLang} />
              </h3>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-blue-800">
                    <TranslatedText translationKey="print.paperTipsTitle" fallback="Paper Tips" lang={currentLang} />
                  </h3>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-amber-800">
                    <TranslatedText translationKey="print.troubleshootingTitle" fallback="Having Trouble?" lang={currentLang} />
                  </h3>
          ...
          <div className="border-t border-gray-200 bg-gray-50 p-6">
            <h3 className="text-md font-medium text-gray-900 mb-3">
              <TranslatedText translationKey="print.morePages" fallback="Want more coloring pages?" lang={currentLang} />
            </h3>
