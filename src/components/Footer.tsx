      ...
      <div className="container mx-auto px-4 py-12">
        <div className="md:flex md:justify-between md:gap-8">
          <div className="mb-8 md:mb-0 md:w-1/3">
            <Link href="/" className="flex items-center">
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-blue-600 dark:text-blue-400">Coloring AI</span>
            </Link>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 md:w-2/3">
            <div>
              <h2 className="mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-gray-100 tracking-wider">
                {t('footer.resources')}
              </h2>
              <ul className="text-gray-600 dark:text-gray-400 space-y-4">
                ...
                <li>
                  <Link href="/gallery" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                    {t('common.gallery')}
                  </Link>
                </li>
                <li>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm text-center sm:text-left">
            © {currentYear} <Link href="/" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Coloring AI</Link>. {t('footer.rights')}
          </p>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-4 sm:mt-0 text-center sm:text-right">
            {t('footer.tagline')}
          </p>
        </div>
      </div>
