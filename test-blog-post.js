...
// Function to create a test blog post directly in the database
async function createTestBlogPost() {
  ...
  // Output the test post as JSON
  fs.writeFileSync('test-blog-post.json', JSON.stringify(testPost, null, 2));
  console.log('Created test blog post JSON file.');
  console.log('To add this post to your database, you can use the Supabase dashboard or API.');
  console.log('\nHere\'s how to add it using Supabase SQL:');
  console.log(`
